...
export var Composer = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var handleInputTypeChange = useCallback(
    function () {
  ...
  var handleInputBlur = useCallback(
    function (e) {
  ...
  var handleInputKeyDown = useCallback(
    function (e) {
  ...
  var handleTextChange = useCallback(
    function (value, e) {
      setText(value);
      if (onChange) {
        onChange(value, e);
  ...
  var handleSendBtnClick = useCallback(
    function (e) {
      send();
      e.preventDefault();
    },
  ...
  var handleAccessoryToggle = useCallback(
    function () {
  ...
  var handleToolbarClick = useCallback(
    function (item, e) {
      if (onToolbarClick) {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        !isInputText && /*#__PURE__*/ React.createElement(Recorder, recorder),
      ),
      !text && rightAction && /*#__PURE__*/ React.createElement(Action, rightAction),
      hasToolbar &&
        /*#__PURE__*/ React.createElement(Action, {
