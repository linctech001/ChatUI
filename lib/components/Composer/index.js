...
var Composer = (exports.Composer = /*#__PURE__*/ _react.default.forwardRef(function (props, ref) {
      ...
      if (typeof window !== 'undefined') {
        var mq =
          wideBreakpoint && window.matchMedia
            ? window.matchMedia('(min-width: '.concat(wideBreakpoint, ')'))
            : false;
        function handleMq(e) {
          setWide(e.matches);
        }
  ...
  var handleInputTypeChange = (0, _react.useCallback)(
    function () {
  ...
  var handleInputKeyDown = (0, _react.useCallback)(
    function (e) {
  ...
  var handleTextChange = (0, _react.useCallback)(
    function (value, e) {
      setText(value);
      if (onChange) {
        onChange(value, e);
  ...
  var handleSendBtnClick = (0, _react.useCallback)(
    function (e) {
      send();
      e.preventDefault();
    },
  ...
  var handleAccessoryToggle = (0, _react.useCallback)(
    function () {
  ...
  var handleToolbarClick = (0, _react.useCallback)(
    function (item, e) {
      if (onToolbarClick) {
  ...
  return /*#__PURE__*/ _react.default.createElement(
    ...
    /*#__PURE__*/ _react.default.createElement(
      ...
      recorder.canRecord &&
        /*#__PURE__*/ _react.default.createElement(_Action.Action, {
      ...
      /*#__PURE__*/ _react.default.createElement(
        ...
        !isInputText && /*#__PURE__*/ _react.default.createElement(_Recorder.Recorder, recorder),
      ),
      !text &&
        rightAction &&
        /*#__PURE__*/ _react.default.createElement(_Action.Action, rightAction),
      hasToolbar &&
        /*#__PURE__*/ _react.default.createElement(_Action.Action, {
